...
import routeshape.shapes.multi_contour as mc
...
from routeshape.placement import (GRID_STEP_M, MIN_SEPARATION_M, NETWORK_HALF_SIZE_M,
...
from routeshape.export import write_gpx
