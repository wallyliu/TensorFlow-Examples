...
from routeshape.network import CENTER_LAT, CENTER_LON, download_walk_graph, generate_heart_points
from routeshape.matching import (
    DEVIATION_WEIGHT,
    NoRouteFoundError,
    N_CANDIDATES,
    SNAP_WEIGHT,
...
OUT_SEARCH = paths.RESULTS / "poc3_search_map.png"
OUT_BEST = paths.RESULTS / "poc3_best_route.png"
OUT_TOP = paths.RESULTS / "poc3_top_routes.png"
